...
impl PrivilegedDispatcher {
    ...
    fn handle_spawn_episode(
        ...
        //
        // Per RFC-0019 REQ-0002, capability manifests must be real (no empty
        // allowlists). Per DEC-0005, manifests should be stored in CAS and
        // loaded by hash.
        //
        // For now, we use role-based manifest selection:
        // - Reviewer: Use canonical reviewer v0 manifest (Read, Git, Artifact,
        //   ListFiles, Search)
        // - Other roles: Use empty manifest (fail-closed) until role-specific manifests
        //   are defined
        //
